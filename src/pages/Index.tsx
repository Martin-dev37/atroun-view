...
import facilityImage from '@/assets/facility-processing.jpg';
  ...
  return <Layout>
      ...
      <Section variant="muted">
        ...
        <div className="mt-12 md:mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {highlights.map((item, index) => <div key={item.title} className="bg-background p-6 rounded-lg shadow-soft animate-fade-in" style={{
      ...
      <Section>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="order-2 lg:order-1">
            <img alt="ATROUN processing facility" className="rounded-lg shadow-elevated w-full aspect-[4/3] object-cover" src="/lovable-uploads/47078f44-976a-40a1-863a-3bfcbe7c89d0.png" />
          </div>
          <div className="order-1 lg:order-2">
            <SectionHeader title="Technology Built for African Conditions" subtitle="Our platform combines proven lyophilization technology with modular, scalable design principles suited to the realities of East African agriculture." />
            <ul className="mt-8 space-y-4">
              {['Feedstock valorization across multiple crop categories', 'Controlled processing environments with quality documentation', 'Ingredient recovery and fractionation for diverse end markets', 'Biochar production from organic residues'].map(item => <li key={item} className="flex items-start gap-3">
